...
pub struct DesktopAgentApp {
    ...
    pub(super) reenrollment_token: String,
    pub(super) reenrollment_dialog: bool,
    ...
    pub(super) execution_profiles_dialog: bool,
    // retain the just-saved action text until the collection status catches up.
    pub(super) execution_profile_feedback: Option<ProfileApprovalFeedback>,
    ...
    pub(super) tray: Option<AgentTray>,
    ...
    pub(super) last_tray_signature: Option<String>,
    ...
    pub(super) exit_dialog: bool,
    pub(super) exit_dont_ask_again: bool,
...
impl DesktopAgentApp {
    ...
    pub(super) fn show_execution_profile_approval_dialog(
        &mut self,
        ctx: &egui::Context,
    ...
    pub(super) fn open_command_center(&self) {
    ...
    pub(super) fn show_exit_dialog(&mut self, ctx: &egui::Context) {
        if !self.exit_dialog {
            return;
        }
    ...
    pub(super) fn start_enrollment(&mut self) {
    ...
    pub(super) fn show_reenrollment_dialog(&mut self, ctx: &egui::Context, reason: Option<&str>) {
    ...
    pub(super) fn label_editor(&mut self, ui: &mut egui::Ui) {
        ui.label(
            egui::RichText::new(
    ...
    pub(super) fn commit_label_input(&mut self) {
    ...
    pub(super) fn sync_tray(&mut self, presentation: &StatusPresentation) {
    ...
    pub(super) fn activity_panel(ui: &mut egui::Ui, metrics: &AgentMetrics) {
        ui.add_space(2.0);
        ui.horizontal_wrapped(|ui| {
    ...
    pub(super) fn runtime_lifecycle(ui: &mut egui::Ui, dashboard: &RuntimeDashboard<'_>) {
        ui.horizontal(|ui| {
            ui.strong("Runtime");
            ui.label(
    ...
    pub(super) fn runtime_dashboard(ui: &mut egui::Ui, dashboard: RuntimeDashboard<'_>) {
        ui.add_space(4.0);
    ...
    pub(super) fn settings_essentials(&mut self, ui: &mut egui::Ui) {
        ui.group(|ui| {
    ...
    pub(super) fn settings_desktop(&mut self, ui: &mut egui::Ui) {
        ui.group(|ui| {
    ...
    pub(super) fn settings_worker_tuning(&mut self, ui: &mut egui::Ui) {
        ui.group(|ui| {
    ...
    pub(super) fn resource_charts(ui: &mut egui::Ui, samples: &[agent::ResourceSample]) {
    ...
    pub(super) fn save_log(&self, lines: &[String]) {
