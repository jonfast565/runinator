    ...
    <B::Db as Database>::QueryResult: RowsAffected,
{
    ...
    async fn create_workflow_node_run(
        ...
        // the origin node run is supplied by the runtime, which knows the true edge taken
    ...
    async fn release_workflow_mutexes(
        ...
        // them here makes every out-of-runtime settlement path use the same cleanup operation.
