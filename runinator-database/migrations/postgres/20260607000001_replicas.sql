...
ALTER TABLE workflow_runs ADD COLUMN IF NOT EXISTS trigger_actor_replica_id UUID NULL REFERENCES replicas(replica_id);
...
ALTER TABLE workflow_node_runs ADD COLUMN IF NOT EXISTS current_executor_replica_id UUID NULL REFERENCES replicas(replica_id);
ALTER TABLE workflow_node_runs ADD COLUMN IF NOT EXISTS last_executor_replica_id UUID NULL REFERENCES replicas(replica_id);
