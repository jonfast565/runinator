...
ALTER TABLE replicas ADD COLUMN kicked_at BIGINT NULL;
CREATE INDEX idx_replicas_owner_kicked
...
ALTER TABLE agent_enrollment_tokens ADD COLUMN permanent BOOLEAN NOT NULL DEFAULT FALSE;
