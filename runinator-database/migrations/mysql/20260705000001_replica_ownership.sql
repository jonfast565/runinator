...
ALTER TABLE replicas ADD COLUMN registered_by_principal_id BINARY(16) NULL;
ALTER TABLE replicas ADD COLUMN registered_by_kind TEXT NULL;
ALTER TABLE replicas ADD COLUMN registered_by_org_id BINARY(16) NULL;
