...
ALTER TABLE idempotency_keys ADD COLUMN owner_node_run_id BLOB NULL;
ALTER TABLE idempotency_keys ADD COLUMN claimed_at INTEGER NULL;
ALTER TABLE idempotency_keys ADD COLUMN completed_at INTEGER NULL;
