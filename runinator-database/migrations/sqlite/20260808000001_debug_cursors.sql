...
ALTER TABLE workflow_ready_nodes ADD COLUMN cursor_id BLOB NULL;
ALTER TABLE workflow_node_runs ADD COLUMN cursor_id BLOB NULL;
...
ALTER TABLE workflow_node_runs ADD COLUMN speculative INTEGER NOT NULL DEFAULT 0;
