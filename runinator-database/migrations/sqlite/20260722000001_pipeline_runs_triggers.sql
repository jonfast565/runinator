...
CREATE TABLE IF NOT EXISTS pipeline_runs (
    id BLOB PRIMARY KEY,
    pipeline_id BLOB NOT NULL REFERENCES pipelines(id),
    ...
    trigger_actor_replica_id BLOB NULL,
...
CREATE TABLE IF NOT EXISTS pipeline_trigger_firings (
    id BLOB PRIMARY KEY,
    trigger_id BLOB NOT NULL REFERENCES pipeline_triggers(id) ON DELETE CASCADE,
    fire_key TEXT NOT NULL,
    pipeline_run_id BLOB NULL REFERENCES pipeline_runs(id),
...
ALTER TABLE workflow_runs ADD COLUMN pipeline_run_id BLOB NULL REFERENCES pipeline_runs(id);
