...
ALTER TABLE notification_deliveries ADD COLUMN dedupe_key TEXT NULL;
ALTER TABLE notification_deliveries ADD COLUMN command_json TEXT NULL;
ALTER TABLE notification_deliveries ADD COLUMN published_at INTEGER NULL;
ALTER TABLE notification_deliveries ADD COLUMN claimed_by TEXT NULL;
ALTER TABLE notification_deliveries ADD COLUMN claimed_until INTEGER NULL;
