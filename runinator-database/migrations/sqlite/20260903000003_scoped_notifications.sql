ALTER TABLE notification_policies ADD COLUMN org_id BLOB NULL;
ALTER TABLE notifications ADD COLUMN org_id BLOB NULL;
ALTER TABLE notifications ADD COLUMN source_resource_type TEXT NULL;
ALTER TABLE notifications ADD COLUMN source_resource_id BLOB NULL;
