...
impl<T: DeliveryStore + OrchestrationStore> TracingBroker<T> {
    ...
    pub(super) async fn record<M: Serialize + ?Sized>(
        &self,
        channel: &'static str,
    ...
    pub(super) async fn record_effect_message(
        &self,
        direction: BrokerMessageDirection,
    ...
    pub(super) async fn record_effect_delivery(&self, delivery: &EffectDelivery) {
        self.record(
            "effect",
    ...
    pub(super) async fn record_effect_result_message(
        &self,
        direction: BrokerMessageDirection,
    ...
    pub(super) async fn record_effect_result_delivery(&self, delivery: &EffectResultDelivery) {
        self.record(
            "effect_result",
            BrokerMessageDirection::Received,
            "effect_result",
    ...
    pub(super) async fn record_wake_message(
        &self,
        direction: BrokerMessageDirection,
        message: &WakeMessage,
    ) {
    ...
    pub(super) async fn record_wake_delivery(&self, delivery: &WakeDelivery) {
        self.record(
            "wake",
            BrokerMessageDirection::Received,
            "wake_command",
    ...
    pub(super) async fn record_ingress_message(
        &self,
        direction: BrokerMessageDirection,
    ...
    pub(super) async fn record_ingress_delivery(&self, delivery: &IngressDelivery) {
