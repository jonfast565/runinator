...
pub fn result_event_applied(applied: bool) {
    if applied {
        ...
        runinator_tui::counter("engine", "results applied", 1);
        ...
        runinator_tui::counter("engine", "duplicate results", 1);
...
pub fn result_event_retried() {
    ...
    runinator_tui::counter("engine", "results retried", 1);
...
pub fn result_event_dead_lettered() {
    ...
    runinator_tui::counter("engine", "results dead-lettered", 1);
...
pub fn result_receive_error() {
    ...
    runinator_tui::counter("engine", "result receive errors", 1);
...
pub fn ingress_applied() {
    runinator_tui::counter("engine", "ingress applied", 1);
...
pub fn ingress_retried() {
    runinator_tui::counter("engine", "ingress retried", 1);
...
pub fn ingress_dead_lettered() {
    runinator_tui::counter("engine", "ingress dead-lettered", 1);
...
pub fn triggers_fired(count: u64) {
    ...
    runinator_tui::counter("engine", "triggers fired", count);
...
pub fn vm_continuation_driven(outcome: &'static str) {
    runinator_tui::counter("engine", "continuations", 1);
    runinator_tui::activity("engine", format!("VM continuation {outcome}"), None);
...
pub fn vm_driver_failure() {
    runinator_tui::counter("engine", "VM failures", 1);
...
pub fn queue_snapshot(queue: &'static str, depth: u64, claimed: u64, oldest_age_seconds: u64) {
    runinator_tui::gauge("engine", "queue depth", depth as i64);
    runinator_tui::gauge("engine", "queue claimed", claimed as i64);
    runinator_tui::gauge("engine", "oldest queue age (s)", oldest_age_seconds as i64);
