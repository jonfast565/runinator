...
pub struct StandaloneProvisioner {
    ...
    pub(super) nodes: Mutex<BTreeMap<String, Node>>,
...
impl StandaloneProvisioner {
    ...
    pub(super) fn manageable(kind: ReplicaKind) -> bool {
        matches!(
            kind,
    ...
    pub(super) async fn remove_node(&self, id: &str) -> Result<(), SendableError> {
