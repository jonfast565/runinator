...
pub struct ActiveWorkspace {
    pub(super) execution: WorkspaceExecution,
    pub(super) replica_id: uuid::Uuid,
    pub(super) directory: Option<tempfile::TempDir>,
    pub(super) path: std::path::PathBuf,
    pub(super) results: std::collections::BTreeMap<String, Value>,
    pub(super) objects: std::sync::Arc<super::super::workspace_objects::WorkerObjects>,
    pub(super) phases: WorkspacePhaseReporter,
}
...
impl ActiveWorkspace {
    ...
    pub(super) async fn restore_in(
        ...
        let (local, usage) = tokio::task::spawn_blocking(move || -> Result<_, SendableError> {
            ...
            Ok((
                Some(super::super::workspace_objects::LocalObjects::new(
                    store, scratch,
                )),
                usage,
            ))
        ...
        .await??;
        let objects = std::sync::Arc::new(super::super::workspace_objects::WorkerObjects::new(
    ...
    pub async fn save(
        ...
        let revision_id = tokio::task::spawn_blocking(move || -> Result<_, SendableError> {
            ...
            let stage = super::super::workspace_objects::CheckedStore {
                inner: staging,
