...
Cluster deployment is never implicit. Build and deploy only when an operator explicitly requests
it; otherwise, finish with local verification and report that no deployment was performed.
