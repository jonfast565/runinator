...
describe("command center permissions API in web mode", () => {
  ...
  it("maps user creation to the users endpoint", async () => {
    await createUser({ username: "ada", password: "secret", email: "ada@example.com", is_admin: true });
  ...
  it("maps team rename and membership endpoints", async () => {
    ...
    await addTeamMember("00000000-0000-0000-0000-000000000001", "00000000-0000-0000-0000-000000000002");
