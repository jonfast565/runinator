...
export const testNodeKindCatalog: WorkflowNodeKindMetadata[] = [
  ...
  nodeMeta("loop", {
  ...
  }, [
    {
      ...
      label: "Loop body",
      taxonomy: "direct",
      target: { base: "transitions", path: ["next"] },
      multiple: false,
      editable_label: false,
      editable_condition: false,
      orderable: false,
    },
    {
      ...
      label: "Loop exit",
      taxonomy: "direct",
      target: { base: "transitions", path: ["on_success"] },
      multiple: false,
      editable_label: false,
      editable_condition: false,
      orderable: false,
    ...
    output_type: {
      type: "struct",
      fields: {
        item: { required: false, ty: { type: "any" } },
        index: { required: true, ty: { type: "integer" } },
        has_next: { required: true, ty: { type: "boolean" } },
        count: { required: true, ty: { type: "integer" } },
        last: { required: false, ty: { type: "any" } },
        results: { required: true, ty: { type: "array", items: { type: "any" } } },
      },
    },
  }),
  nodeMeta("map", {
