// stream tokenizer and highlight style for the wdl editor.
...
export const wdlParser = StreamLanguage.define<WdlState>({
  startState: () => ({
...
export const wdlHighlightStyle = HighlightStyle.define([
