...
type PluginServiceCallFn = unsafe extern "C" fn(call: *const c_char, args: *const c_char, timeout_secs: i64) -> c_int;
...
impl Plugin {
    ...
    pub fn plugin_service_call(&self, name: String, args: String, timeout_secs: i64) -> Result<(), SendableError> {
        unsafe {
            ...
            let plugin_interface = (service_call_symbol)(name_cstr.as_ptr(), args_cstr.as_ptr(), timeout_secs);
