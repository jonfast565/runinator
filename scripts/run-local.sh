...
COMMAND="${1:-start}"
WORKFLOWS_FILE="${RUNINATOR_WORKFLOWS_FILE:-$ROOT_DIR/packs/sdlc/sdlc.rexrapm}"
SMOKE_WORKFLOWS_FILE="${RUNINATOR_SMOKE_WORKFLOWS_FILE:-$ROOT_DIR/packs/hello-world/hello-world.rexrapm}"
