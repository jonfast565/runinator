...
pub fn projected_monthly_cents(groups: &[OrgResourceGroup], card: &RateCard) -> u64 {
    groups
        .iter()
...
pub fn org_pool_group(slug: &str, kind: ReplicaKind) -> String {
...
pub fn integrate_usage(org_id: Uuid, samples: Vec<UsageSample>, card: &RateCard) -> OrgUsage {
