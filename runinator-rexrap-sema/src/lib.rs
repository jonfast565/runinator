// runinator-rexrap-sema: the author-time analysis layer, sitting between the parser and lowering.
...
// needs the type policy and the pack's workflow signatures, and `runinator-rexrap-codegen` needs
// the rest.
