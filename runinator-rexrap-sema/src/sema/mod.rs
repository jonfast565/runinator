// semantic analysis over the rexrap ast. runs after parsing and before lowering so every
...
use runinator_rexrap_syntax::ast::{Block, Document, Stmt, StmtKind};
...
impl Diagnostic {
    ...
    pub fn render(&self, src: &str) -> String {
        ...
        runinator_rexrap_syntax::errors::render_snippet(src, self.span, label, &self.message)
    }
}
