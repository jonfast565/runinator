...
pub struct S3BlobClient {
    ...
    pub(super) credential: Option<BlobCredential>,
}
...
impl S3BlobClient {
    ...
    pub(super) async fn check(response: Response, context: &str) -> Result<Response> {
    ...
    pub(super) fn meta_from_headers(key: &ObjectKey, response: &Response) -> ObjectMeta {
